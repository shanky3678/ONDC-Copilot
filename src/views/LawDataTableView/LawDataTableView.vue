...
<body>
        ...
        <section  v-if="!isEmptyOrNull(documentDetails)" class="flex flex-col md:flex-row h-screen items-center ">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td
                                        class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p
                                            class="text-gray-900 whitespace-no-wrap">{{ documentDetails.enactment_date  }}</p>
                                    </td>
                                ...
                                <tr>
                                    <td
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-3">
                                                <p
                                                    class="text-[#094B72] whitespace-no-wrap font-bold">
                                                    Act Number:
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <td
                                        class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p
                                            class="text-gray-900 whitespace-no-wrap">{{ documentDetails.act_number }}</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p
                                            class="text-gray-900 whitespace-no-wrap">The
                                            {{ documentDetails.short_title }}</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p
                                            class="text-gray-900 whitespace-no-wrap">{{ getStateName(documentDetails.state_code)  }}</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p
                                            class="text-gray-900 whitespace-no-wrap">{{ documentDetails.act_department }}</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p
                                            class="text-gray-900 whitespace-no-wrap">{{ documentDetails.act_details['Act ID:'] }}</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p
                                            class="text-gray-900 whitespace-no-wrap">{{ documentDetails.act_details['Act Year:']  }}</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p
                                            class="text-gray-900 whitespace-no-wrap">{{ documentDetails.act_details['Long Title:'] }}</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p
                                            class="text-gray-900 whitespace-no-wrap">{{ documentDetails.act_details['Ministry:'] }}</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p
                                            class="text-gray-900 whitespace-no-wrap">7th
                                            {{ 
                                            documentDetails.act_details['Enforcement Date:']
                                            }}</p>
                                    </td>
            ...
            <div 
                class="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-2/5 h-screen px-6 lg:px-16 xl:px-12
                ...
                <div
                    ...
                    <embed :src="documentDetails.pdf_link" width="100%"
                        height="80%">
            ...
            <div itemscope itemtype="https://schema.org/FAQPage">
                <div class="py-10 px-4 container mx-auto">
                    ...
                    <ul class="grid gap-6" data-list="faq" >
                        <li v-for="(value, key) in documentDetails.sections" :key="key" class="group" itemscope itemprop="mainEntity"
                            itemtype="https://schema.org/Question">
                            <input class="peer/option-1 hidden" type="radio"
                                id="option-1" name="options">
                            <label
        ...
        <section v-if="!isEmptyOrNull(documentDetails)" class="  mt-20  ">
            ...
            <div
                ...
                <p class="mb-3 text-[#94979b]"> These tags are mentioned in the
                    PDF and have
                    been extracted
                    from it. </p>
                <!--label round full-->
