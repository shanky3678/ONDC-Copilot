<template>
    ...
    <div class="w-[40%] mx-auto bg-white border border-[#DFDFDF] shadow-lg rounded shadow-[#DFDFDF] my-[70px] py-[50px] px-[55px] pb-6 flex justify-center items-center">
        <h1 class="font-bold font- text-[29px] leading-[20px] text-black text-shadow ">Verifying user ....</h1><br>
    </div>
</body>
</template>
