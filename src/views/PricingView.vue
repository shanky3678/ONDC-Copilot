...
<div class="min-h-screen flex justify-center items-center">
    ...
    <div class>
        <div class="text-center font-semibold">
            <h1 class="text-5xl">
                <span class="text-blue-700 tracking-wide">Are
                    you E-commerce enterprice <br>
                </span>
                <span> or Compliance firm ?</span>
            </h1>
            <p
                class="pt-6 text-xl text-gray-400 font-normal w-full px-8 md:w-full">
                Choose a which API service works best for
                your.
            </p>
        </div>
        <div class="pt-24 flex flex-row">
            ...
            <div
                ...
                <h1 class="text-black font-semibold text-2xl">Data
                    API</h1>
                ...
                <div class="pt-8">
                    <p
                        ...
                        <span class="pl-2">API accese to our
                            <span
                                class="text-black">law database</span>
                        </span>
                    </p>
                    <p
            ...
            <div
                ...
                <h1 class="text-white font-semibold text-2xl">Compliance
                    API</h1>
                <p class="pt-2 tracking-wide">
                    <span class="text-gray-400 align-top">₹
                    </span>
                ...
                <div class="pt-8">
                    <p
                        ...
                        <span class="pl-2">
                            Provies compliance as <span
                                class="text-white">service</span>
                        </span>
                    </p>
                    <p
                        class="font-semibold text-gray-400 text-left pt-5">
                        ...
                        <span class="pl-2">
                            All Indian <span class="text-white">product
                                &
                                services</span>
                        </span>
                    </p>
            ...
            <div
                ...
                <h1 class="text-black font-semibold text-2xl">Custom
                    Compliance API</h1>
                <p class="pt-2 tracking-wide">
                    <span class="text-gray-400 align-top">₹
                    </span>
                ...
                <div class="pt-8">
                    ...
                    <p
                        ...
                        <span class="pl-2">
                            Upload <span class="text-black">custom
                                regulations</span>
                        </span>
                    </p>
                    <p
                        class="font-semibold  text-left pt-5">
                        <span
                            class="material-icons align-middle">
                            done
                        </span>
                        <span class="pl-2">
                            <span class="text-gray-400 ">Compliance
                                checked
                            </span>
                            <span class="text-black"> on
                                documents</span>
