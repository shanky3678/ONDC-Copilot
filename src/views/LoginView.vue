...
<section class="bg-gray-50 min-h-screen flex items-center justify-center">
  ...
  <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
    ...
    <div class="md:w-1/2 px-8 md:px-16">
      ...
      <button @click="login" class="bg-white border py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm hover:scale-105 duration-300 text-[#002D74]">
    ...
    <div class="md:block  w-1/2">
      <img class="rounded-2xl" src="@/assets/images/login-law.jpg">
    </div>
  </div>
</section>
